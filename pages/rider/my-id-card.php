...
<html lang="en">
<head>
    <?php $pageTitle = 'My ID Card - BodaERP'; require __DIR__ . '/../../includes/partials/head-assets.php'; ?>
    <style>
...
<div class="main-content" id="mainContent">
    <?php $pageTitle = 'My ID Card'; require __DIR__ . '/../../includes/partials/topheader.php'; ?>
